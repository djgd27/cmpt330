  ...
  return (
    <>
      <div className="text-center py-12 px-6">
        <h2 className="text-3xl font-semibold mb-4">Experience Innovation</h2>
        <p className="text-lg max-w-2xl mx-auto">
          Discover the cutting-edge technology that powers the iPhone 16 Pro.
        </p>
      </div>
